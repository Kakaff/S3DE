...
namespace S3DE.Input
{
    ...
    public enum KeyState
    {
        ...
        Released = 0,
        /// <summary>
        /// The key was pressed down this frame.
        /// </summary>
        Pressed = 1,
    }
    ...
    {
        static HashSet<KeyCode> pressedKeys = new HashSet<KeyCode>();
        static HashSet<KeyCode> releasedKeys = new HashSet<KeyCode>();
        ...
        public static KeyState GetKeyState(KeyCode key)
        {
            ...
            else if (releasedKeys.Contains(key))
                return KeyState.Released;
            else
                return KeyState.Idle;
        }

        internal static void UpdateKeyStates()
        {
            foreach (KeyCode key in (KeyCode[])Enum.GetValues(typeof(KeyCode)))
            {
                ...
                {
                    if (cks != KeyState.Pressed)
                    {
                        pressedKeys.Add(key);
                        if (cks == KeyState.Released)
